...
class Ticket(BaseModel):
    ...
    category: Literal["регламент", "доступ", "инцидент", "документация"] = Field(
        description=
            "Категория обращения. "
            "регламент - вопросы о порядке действий, правилах, сроках и согласованиях; "
            "доступ - получение, восстановление или изменение доступа; "
            "инцидент - поломка, остановка или неправильная работа оборудования; "
            "документация - запрос документов, инструкций, схем или паспортов. "
    ...
    equipment_id: Optional[str] = Field(
        default=None,
        description=
            "Идентификатор оборудования, явно указанного в обращении. "
            "Приводи написание к виду из реестра, например КМ-101, П-7, ЭЛОУ-АВТ-6. "
            "Если оборудование в обращении не названо, укажи null. "
            "Не придумывай и не угадывай идентификатор оборудования."        
    )

    priority: Literal["низкий", "средний", "высокий"] = Field(
        description=
            "Приоритет обращения. "
            "высокий - авария, остановка производства или ситуация, требующая срочного решения; "
            "средний - проблема мешает работе, но нет полной остановки; "
            "низкий - обычный запрос без срочности. "
            "Выбери только одно значение: низкий, средний или высокий."        
    )
